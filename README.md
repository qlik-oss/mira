...
This information is generated at build-time of the docker image, but if running Mira as a non-dockerized process this file (`version.json`) must also be present locally.
