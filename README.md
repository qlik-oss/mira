...
Mira's REST API is described in the [api-doc.yml](./doc/api-doc.yml) [OpenAPI](https://www.openapis.org/) document. The api specification is generated from JSDoc, and can be regenerated by running:
